...
const sendEmail = (to, url, txt) => {
    ...
    const mailOptions = {
        ...
        to: to,
        subject: "Activation Link to ybrayevweb.ru",
        html:
        `
        <div style="max-width: 700px; margin: auto; border: 10px solid #ddd; padding: 50px 20px; font-size: 14px">
        <h2 style="text-align: center; text-transform: uppercase; color: teal;">Welcome to the ybrayevweb.</h2>
        <p>Congratulations! You're almost set tot start using ybrayevweb.
